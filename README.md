# Official chucknorris.io Google Chrome extension
...
The extension is available in the official [google chrome webstore](https://chrome.google.com/webstore/detail/jmdcikmmlghcmlnebegbmgibhfjnimla). Navigate to the download page and hit `ADD TO CHROME`.
